...
TEST(SPSCQueueTest, PopFromEmptyQueue)
{
  SharedData<int, 16> shared_data;
  Consumer<int, 16> consumer(shared_data);
...
TEST(SPSCQueueTest, MultiplePushAndPop)
{
  SharedData<int, 16> shared_data;
  Producer<int, 16> producer(shared_data);
  Consumer<int, 16> consumer(shared_data);
...
TEST(SPSCQueueTest, EmplaceTest)
{
  SharedData<int, 16> shared_data;
  Producer<int, 16> producer(shared_data);
  Consumer<int, 16> consumer(shared_data);
...
TEST(SPSCQueueTest, PushPopStrings)
{
...
TEST(SPSCQueueTest, PushPopStructs)
{
...
//TODO: test ProducerConsumerThreaded
...
TEST(SPSCQueueTest, SingleElementCapacity)
{
